...
namespace displayI2C
{
    class displayI2CLCD
    {
        ...
        public displayI2CLCD(byte deviceAddress, string controllerName, byte Rs, byte Rw, byte En, byte D4, byte D5, byte D6, byte D7, byte Bl, byte[] LineAddress) : this(deviceAddress, controllerName, Rs, Rw, En, D4, D5, D6, D7, Bl)
        {
            this._LineAddress = LineAddress;
        }


        public displayI2CLCD(byte deviceAddress, string controllerName, byte Rs, byte Rw, byte En, byte D4, byte D5, byte D6, byte D7, byte Bl) 
        {
            // Configure pins
            this._Rs = Rs;
            this._Rw = Rw;
